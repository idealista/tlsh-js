...
describe("Tlsh", function(){
	it("returns an error computing hash without input", function(){
		expect(function(){
			tlsh.hash();
		}).toThrowError(tlsh.InsufficientComplexityError);
	});
	...
	it("returns a hash using valid input 1", function(){
		...
		expect(tlsh.hash(str)).toBe('09F05A198CC69A5A4F0F9380A9EE93F2B927CF42089EA74276DC5F0BB2D34E68114448');
	});
	...
	it("returns a hash using valid input 2", function(){
		...
		expect(tlsh.hash(str)).toBe('301124198C869A5A4F0F9380A9AE92F2B9278F42089EA34272885F0FB2D34E6911444C');
	});
	...
	it("returns a hash using valid input 3", function(){
		...
		expect(tlsh.hash(str)).toBe('6FF02BEF718027B0160B4391212923ED7F1A463D563B1549B86CF62973B197AD2731F8');
	});
});
